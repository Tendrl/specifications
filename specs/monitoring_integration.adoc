...
When monitoring integration starts then monitoring-integration is configured
from a configure file which is present in /etc/tendr/monitoring_integration/monitoring-integration.conf.
Then monitoring_integration will create dashboards and datasources in grafana using predefined
json files in tendrl/monitoring_integration/grafana with the help of util functions. When
...
new dashboard otherwise it will skip. (https://github.com/Tendrl/monitoring-integration/pull/1)
