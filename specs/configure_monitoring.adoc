...
----
Note:
The flow definition will be loaded by Tendrl/performance_monitoring to the
'/_tendrl/definitions/integrations.d/performance_monitoring' directory in etcd
and an includes statement of the form:
'#include /_tendrl/definitions/integrations.d/performance_monitoring'
will be added to the master definitions file at '/_tendrl/definitions/master'
----

==== Tendrl/common impact:

A new atom 'check_service_status' is implemented and a corresponding entry is
made under 'Service' object of Tendrl/common definition file as:
